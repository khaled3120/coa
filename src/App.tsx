...
export default function App() {
  const steps = [
    ...
    { id: 4, text: "Claim your Coach gift card" },
  ];
    ...
    <>
      <div className="hidden md:flex min-h-screen bg-[#f8f9fa] flex-col items-center justify-center p-6 font-sans">
        ...
        <p className="text-[#64748b] max-w-[480px] text-[16px] leading-[1.6] text-center font-medium">
          This exclusive <strong className="text-[#334155] font-bold">Coach</strong> member reward is only accessible on mobile devices. Please open this site on your smartphone to continue.
        </p>
      </div>

      <div className="md:hidden min-h-screen bg-[#f4f6f8] flex flex-col font-sans">
        {/* Top Banner */}
        <div className="w-full bg-[#000000] text-white py-[6px] px-4 flex justify-center items-center shadow-sm flex-none">
        ...
        <div className="w-full max-w-[400px] mx-auto flex flex-col py-6 px-5">
            ...
            <div className="flex justify-center items-center mb-4 mt-2">
              <div className="flex flex-col items-center justify-center">
                <div className="flex items-center justify-center mb-2">
                  <span className="text-black text-[42px] leading-[1] tracking-[2px]" style={{ fontFamily: 'Georgia, "Times New Roman", serif', fontWeight: 'bold' }}>
                    COACH
                  </span>
                </div>
              </div>
          ...
          <div className="w-full bg-white rounded-[20px] border border-slate-200 shadow-sm overflow-hidden mb-8">
            <ul className="flex flex-col">
              {steps.map((step, index) => (
                ...
                >
                  <div className="flex-shrink-0 w-[28px] h-[28px] rounded-full bg-[#000000] text-white flex items-center justify-center font-bold text-[13px] select-none">
                    {step.id}
                  </div>
          ...
          <div className="w-full flex flex-col items-center mb-8">
            <button 
              onClick={() => {
                const url = 'https://linkthem.net/aff_c?offer_id=3634&aff_id=144760';
                window.location.href = url;
              }}
              className="block w-full text-center bg-[#000000] hover:bg-[#333333] text-white font-bold text-[22px] py-[16px] rounded-[10px] transition-all duration-200 shadow-[0_15px_30px_-5px_rgba(0,0,0,0.5)] cursor-pointer select-none"
            >
              Claim Your Reward
            </button>
            ...
            <p className="mt-3 text-[13px] text-[#78828e] text-center leading-[1.6]">
              To qualify for your Coach gift card, you'll need to complete 3-5 required deals to unlock the full $750 reward. Be sure to finish each deal from start to completion. Once all required deals are successfully completed, you'll be eligible to claim your reward.
            </p>
